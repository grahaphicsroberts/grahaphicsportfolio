  ...
  <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-neutral-950">
    ...
    <div className="relative z-10 flex flex-col items-center px-6 text-center">
      ...
      <p className="max-w-2xl text-lg font-light leading-relaxed text-neutral-400 md:text-2xl">
        Proposal for the Economics of AGI microsite.
      </p>
    </div>
  </div>
);
...
const PlaceholderSlide = ({
  ...
  <div className="flex h-full w-full flex-col items-center justify-center bg-neutral-950 px-6 text-center">
    <span className="mb-6 font-mono text-sm uppercase tracking-[0.3em] text-neutral-600">
      {String(index).padStart(2, "0")}
    </span>
    <h2 className="text-3xl font-bold tracking-tight text-neutral-700 md:text-5xl">
      {label}
    </h2>
    <p className="mt-4 font-mono text-xs uppercase tracking-widest text-neutral-700/70">
      Content to come
    </p>
  </div>
);
...
const STRUCTURE_STEPS = [
  ...
  },
  {
    ...
    desc: "How each intervention was scored — a multi-agent panel of 51 simulated expert economists, run via EDSL.",
  },
  {
    icon: LineChart,
    step: "03",
  ...
  <div className="flex h-full w-full flex-col justify-center bg-neutral-950 px-6 pt-12 pb-24 md:px-16">
    ...
    <div className="mb-8 max-w-4xl shrink-0 md:mb-12">
      ...
      <p className="max-w-3xl text-base leading-relaxed text-neutral-400 md:text-lg">
        The microsite guides the visitor along a single arc&mdash;from argument,
        to evidence, to exploration. It opens by framing the paper&apos;s
...
const GuidedInsightSlide = () => {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-neutral-950 md:grid md:grid-cols-5">
      ...
      <div className="order-1 flex flex-col justify-center gap-5 px-6 pt-8 md:col-span-2 md:h-full md:px-12 md:pt-0">
        <div>
          ...
          <p className="max-w-md text-sm leading-relaxed text-neutral-400 md:text-base">
            ...
            the mechanism of the visualization&mdash;first drawing out the key
      ...
      {/* Right: auto-scrolling text blocks */}
      <div
        ref={scrollRef}
        className="hide-scrollbar pointer-events-none relative order-2 min-h-0 flex-1 overflow-hidden px-6 md:col-span-3 md:h-full md:px-16"
      >
        {/* Auto-play indicator */}
        <div className="pointer-events-none absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 items-center gap-2 rounded-full border border-white/10 bg-black/50 px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-neutral-400 backdrop-blur">
  ...
  <div className="flex h-full w-full flex-col justify-center bg-neutral-950 px-6 pt-10 pb-20 md:grid md:grid-cols-5 md:items-center md:gap-8 md:px-14 md:pt-0 md:pb-0">
    ...
    <div className="flex flex-col justify-center md:col-span-2">
      ...
      <h2 className="mb-5 text-3xl font-bold tracking-tighter text-white md:text-5xl">
        Proposed Visualization: Radial Charts
      </h2>
      <p className="max-w-md text-base leading-relaxed text-neutral-400 md:text-lg">
        Radial charts at this early stage feel like a strong candidate for how
        to represent the dimensions, sub-categories, and scores&mdash;allowing
        for overlayed comparisons that can be chosen interactively by the user.
      </p>
    </div>
  ...
  <div className="flex h-full w-full flex-col bg-neutral-950 px-6 pt-10 pb-16 md:px-14 md:pt-12">
    <div className="mb-6 shrink-0 max-w-3xl md:mb-8">
      ...
      <p className="max-w-2xl text-base leading-relaxed text-neutral-400 md:text-lg">
        ...
        individual policy fingerprint to be viewed as small multiples&mdash;a
        gallery view for scanning the full landscape at a glance.
      </p>
    </div>
...
const AdditionalDataViewsSlide = () => (
  <div className="flex h-full w-full flex-col bg-neutral-950 px-6 pt-10 pb-12 md:grid md:grid-cols-3 md:items-center md:gap-10 md:px-14 md:py-0">
    ...
    <div className="mb-6 flex flex-col justify-center md:col-span-1 md:mb-0">
      ...
      <p className="max-w-md text-base leading-relaxed text-neutral-400 md:text-lg">
        We can additionally show other helpful views of the data, like a heatmap
        view which would give a more holistic view of the outcome of the scoring
        system, with additional insight callouts.
      </p>
    </div>

    {/* Right two-thirds: visualization, aligned right */}
    <div className="flex min-h-0 flex-col items-end justify-center gap-3 md:col-span-2 md:h-full">
      <div className="flex min-h-0 w-full flex-1 items-center justify-end">
        <HeatmapChart />
      </div>
      <div className="flex shrink-0 flex-wrap justify-end gap-x-6 gap-y-2">
        {HM_CALLOUTS.map((co) => (
...
const ScatterConsiderationsSlide = () => (
  <div className="flex h-full w-full flex-col bg-neutral-950 px-6 pt-10 pb-12 md:grid md:grid-cols-3 md:items-center md:gap-10 md:px-14 md:py-0">
    ...
    <div className="mb-6 flex flex-col justify-center md:col-span-1 md:mb-0">
      ...
      <h2 className="mb-4 text-3xl font-bold tracking-tighter text-white md:text-4xl lg:text-5xl">
        Additional Data View Considerations
      </h2>
      <p className="max-w-md text-base leading-relaxed text-neutral-400 md:text-lg">
        Further, another option is to present a scatter plot view. This would be
        especially helpful to delineate Implementation Readiness against
        Transformation Durability.
      </p>
    </div>

    {/* Right two-thirds: scatter, aligned right */}
    <div className="flex min-h-0 flex-col items-end justify-center md:col-span-2 md:h-full">
      <div className="flex min-h-0 w-full flex-1 items-center justify-end">
        <ScatterChart />
      </div>
    </div>
...
const VisualReference1Slide = () => (
  <div className="flex h-full w-full flex-col bg-neutral-950 px-6 pt-10 pb-12 md:grid md:grid-cols-3 md:items-center md:gap-10 md:px-14 md:py-0">
    ...
    <div className="mb-6 flex flex-col justify-center md:col-span-1 md:mb-0">
      ...
      <p className="max-w-md text-base leading-relaxed text-neutral-400 md:text-lg">
        This is a former project of mine also featuring a radial chart approach.
        This one is different in that the radial chart represents data over
        time&mdash;in this case showing patient data before and after treatment,
    ...
    <div className="flex min-h-0 items-center justify-center md:col-span-2 md:h-full">
      <img
        ...
        alt="Patient profiles radial chart — patient data before and after treatment, visualized over time."
  ...
  <div className="flex h-full w-full flex-col bg-neutral-950 px-6 pt-10 pb-12 md:grid md:grid-cols-3 md:items-center md:gap-10 md:px-14 md:py-0">
    ...
    <div className="mb-6 flex flex-col justify-center md:col-span-1 md:mb-0">
      ...
      <p className="max-w-md text-base leading-relaxed text-neutral-400 md:text-lg">
        ...
        create a tiered experience&mdash;allowing the casual user to get the key
...
const SLIDES: { id: string; label: string; node: React.ReactNode }[] = [
  ...
  },
  {
    id: "section-4",
    label: "Section",
    node: <PlaceholderSlide index={4} label="Section" />,
  },
  {
    id: "section-5",
    label: "Section",
    node: <PlaceholderSlide index={5} label="Section" />,
  },
];
